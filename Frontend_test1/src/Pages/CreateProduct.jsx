...
const CreateProduct = () => {
  ...
  return (
    <>
    <div className='flex items-center  bg-slate-300 dark:bg-slate-900 justify-center text-4xl text-gray-900  dark:text-white pt-9 '>Welcome to My Store <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="ml-2 w-8 h-10 ">
