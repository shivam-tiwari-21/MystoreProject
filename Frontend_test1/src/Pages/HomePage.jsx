...
const HomePage = () => {
  ...
  return (
    <div className="bg-slate-300 dark:bg-slate-900 pt-9">
      {/* Toast Container */}
      <ToastContainer />
      <div className='flex items-center justify-center text-4xl text-gray-900  dark:text-white mb-4 '>Welcome to My Store <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="ml-2 w-8 h-10">
